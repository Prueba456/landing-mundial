...
// });
// activar genero
$( ".elec-mujer" ).click(function() {
  $("#mundial .cabello-icon").css("background-image", "url(images/mujer/master-cabello.png)")
  $('.hombre-display').css('display','none');
  $( ".elec-mujer" ).addClass("active");
  $( ".elec-hombre" ).removeClass("active");

  $( ".mono-inactivo" ).addClass("inactivo");
  $( ".mono-mujer" ).addClass("active");
  $( ".mono-hombre" ).removeClass("active");
  let genero = $(this).attr('data-eleccion');
  $("#genero").val(genero)
  console.log($("#genero").val(genero));
  $(".cont-hover-elementos").css('display','none');
  $(".caracteristicas.no-activo").removeClass("no-activo");
});
$( ".elec-hombre" ).click(function() {
    $("#mundial .cabello-icon").css("background-image", "url(images/hombre/master-cabello.png)")
  $('.hombre-display').css('display','none');
  $( ".elec-hombre" ).addClass("active");
    $( ".elec-mujer" ).removeClass("active");

  $( ".mono-inactivo" ).addClass("inactivo");
  $( ".mono-hombre" ).addClass("active");
  $( ".mono-mujer" ).removeClass("active");
  let genero2 = $(this).attr('data-eleccion');
  $("#genero").val(genero2)
  console.log($("#genero").val(genero2));
  $(".cont-hover-elementos").css('display','none');
  $(".caracteristicas.no-activo").removeClass("no-activo");
});
// activar iconos de seleccion
$('.caracteristicas').hover(function() {
    if ($(this).hasClass("no-activo")) {
      return false;
    }
    $('.cont-hover-elementos .active').removeClass('active');

  $('.cont-hover-elementos').css('display','block')
  $('.'+$(this).attr('data-opcion')+'-hover').addClass('active');
});

// seleccionar imagenes y agregar value al input




$(".cont-hover-elementos div span").click(function(){
  var caracter = $(this).parent().find("input").attr("name");
  for (var i = 1; i < 5; i++) {
    if ($(this).hasClass(caracter + "-" + i)) {
      $('.hombre-display.hombre-'+caracter).css('display','block');
      console.log(i);
      $("#" + caracter ).val(i);
      if ($("#genero").val()=="h") {
        var carpeta = "hombre";
      ...
      if (caracter=="accesorios") {

        $("div.hombre-"+caracter).attr("id","color-"+carpeta + i);

      }else{
        $("img.hombre-"+caracter).attr("src", "images/"+carpeta+ "/"+caracter+i+".png");
      }
    }
   }
var suma = $(".cont-borde").find("input");
var g = $("#genero").val()
var p = $("#piel").val()
var c = $("#cabello").val()
var a = $("#accesorios").val()
var r = $("#ropa").val()
   console.log($("#name-mono").val(g+p+c+a+r));
   if ($("#name-mono").val().length== 5) {
     $(".crear-mono").addClass("active");
   }
});
...
for (var i = 1; i < 5; i++) {
  $("div.hombre-accesorios .ojos").removeClass("color-piel"+i)
}
if ($("#piel").val()==1) {
    $("div.hombre-accesorios .ojos").addClass("color-piel1")
}else if($("#piel").val()==2){
    $("div.hombre-accesorios .ojos").addClass("color-piel2")
    console.log("color piel");

}else if($("#piel").val()==3){
    $("div.hombre-accesorios .ojos").addClass("color-piel3")
}else{
    $("div.hombre-accesorios .ojos").addClass("color-piel4")
}
})
// Creaccion de mono
$(".crear-mono").click(function(){
  $(".cont-borde.form-2").removeClass("paso-2");
  $(".cont-borde.crear-1").addClass("paso-2");
    $(".crea.indicador").removeClass("activo");
  $(".crea.indicador").addClass("usado");
  $(".ingresa.indicador").addClass("activo");
});
// Enviar formulario
...
window.onload = function() {
    ...
    $(".loader").remove();
    setTimeout(function(){
      $("#mundial .imagen-header .ubic-3").addClass("animacion");
    }, 1000);
    setTimeout(function(){
      $("#mundial .imagen-header .ubic-4").addClass("animacion");
    }, 2000);
};
